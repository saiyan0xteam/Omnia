...
This project is released under the **Dash Source-Available License (DSAL)**. 
- **Educational Use:** Permitted (You can inspect the code).
- **Modding:** Fully supported via Python/Lua APIs.
